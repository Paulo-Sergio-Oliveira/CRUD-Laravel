...
<main class="form-signin">
  ...
  <form action="{{ route('auth') }}" method="POST">
    ...
    <h1 class="h3 mb-3 fw-normal mt-2"><b>Sign In to CRUD</b></h1>
    @if ($mensagem = Session::get('erro'))
        <p class="mb-2"> {{$mensagem}} </p>
    @endif
    <div class="form-floating">
      <input type="email" class="form-control up" id="floatingInput" placeholder="name@example.com" name="email">
    ...
    <button class="w-100 btn btn-lg btn-secondary fw-bold border-white bg-white text-dark" type="submit">Sign In</button>
